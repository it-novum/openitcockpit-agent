    ...
    stages {
        ...
        stage('Build agent windows packages') {
            ...
            steps {
                ...
                sh 'ssh -o StrictHostKeyChecking=no -i /var/lib/jenkins/.ssh/id_rsa kress@172.16.166.223 powershell "cd openitcockpit-agent; python.exe -m venv ./python3-windows-env; ./python3-windows-env/Scripts/activate.bat; ./python3-windows-env/Scripts/pip.exe install -r requirements.txt servicemanager pywin32==226; ./python3-windows-env/Scripts/pyinstaller.exe agent.py --onefile; ./python3-windows-env/Scripts/deactivate.bat"'
