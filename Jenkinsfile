    ...
    stages {
        ...
        stage('Publish linux packages') {
            ...
            steps {
                ...
                sh '/var/lib/jenkins/aptly.sh repo add -force-replace buster-agent-unstable /tmp/agent/openitcockpit-agent_*amd64.deb; /var/lib/jenkins/aptly.sh repo add -force-replace focal-agent-unstable /tmp/agent/openitcockpit-agent_*amd64.deb; /var/lib/jenkins/aptly.sh repo add -force-replace bionic-agent-unstable /tmp/agent/openitcockpit-agent_*amd64.deb"'
                sh '/var/lib/jenkins/aptly.sh repo add -force-replace buster-agent-nightly /tmp/agent/openitcockpit-agent_*amd64.deb; /var/lib/jenkins/aptly.sh repo add -force-replace focal-agent-nightly /tmp/agent/openitcockpit-agent_*amd64.deb; /var/lib/jenkins/aptly.sh repo add -force-replace bionic-agent-nightly /tmp/agent/openitcockpit-agent_*amd64.deb"'
                sh '/var/lib/jenkins/aptly.sh repo add -force-replace buster-agent-stable /tmp/agent/openitcockpit-agent_*amd64.deb; /var/lib/jenkins/aptly.sh repo add -force-replace focal-agent-stable /tmp/agent/openitcockpit-agent_*amd64.deb; /var/lib/jenkins/aptly.sh repo add -force-replace bionic-agent-stable /tmp/agent/openitcockpit-agent_*amd64.deb"'
